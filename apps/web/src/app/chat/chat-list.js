/**
 * ChatListController — paginação, busca debounced e querystring da lista de conversas.
 *
 * @param {Object} [options]
 * @param {import("../../bootstrap.js").AppState} options.state
 * @param {HTMLElement|null} options.chatListPaginationInfoEl
 * @param {HTMLElement|null} options.chatListLoadMoreBtnEl
 * @param {(() => void)|null} options.onScheduledSearch — callback após debounce de busca
 * @returns {{ buildQueryString: () => string, updatePaginationUi: () => void, resetPagination: (opts?: object) => void, scheduleSearch: () => void }}
 */
