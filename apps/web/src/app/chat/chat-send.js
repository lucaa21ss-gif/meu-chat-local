/**
 * @typedef {Object} ChatSendDeps
 * @property {import("../../bootstrap.js").AppState} state
 * @property {HTMLTextAreaElement} inputEl         — campo de entrada de texto
 * @property {HTMLInputElement}    imageInputEl    — input file para imagens
 * @property {HTMLButtonElement}   sendBtnEl       — botão enviar
 * @property {HTMLInputElement}    ragToggleEl     — checkbox RAG ativo
 * @property {string}              apiBase         — URL base da API
 * @property {Function}            fetchJson       — client HTTP
 * @property {Function}            filesToBase64   — converte File[] → base64[]
 * @property {(role: string, text: string, opts?: object) => HTMLElement} appendMessage
 * @property {() => void}          showTyping
 * @property {() => void}          hideTyping
 * @property {() => void}          smoothScrollToBottom
 * @property {(msg: string, opts?: object) => void} showStatus
 * @property {() => void}          hideStatus
 * @property {() => { temperature: number, model: string, context: number }} getControls
 * @property {() => Promise<void>} onEnsureActiveChat
 * @property {() => Promise<void>} onLoadChats
