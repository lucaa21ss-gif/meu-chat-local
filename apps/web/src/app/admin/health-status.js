/**
 * HealthStatusController — polling de saúde do sistema (Ollama, DB, disco, SLO, rate limiter).
 *
 * @param {Object} deps
 * @param {import("../../bootstrap.js").AppState} deps.state
 * @param {Function}      deps.fetchJson
 * @param {(health: object) => object} deps.buildHeaderPresentation — formata badges de saúde
 * @param {HTMLElement|null} deps.ollamaStatusBadgeEl
 * @param {HTMLElement|null} deps.systemHealthBadgeEl
 * @param {HTMLElement|null} deps.ollamaLatencyTextEl
 * @param {HTMLElement|null} deps.healthSummaryTextEl
 * @param {HTMLElement|null} deps.healthChecksTextEl
 * @param {HTMLElement|null} deps.healthSloTextEl
 * @returns {{ checkHealth: () => Promise<boolean> }}
 */
