...
/**
 * StorageController — monitoramento e gestão de armazenamento (uso, limpeza, limites).
 *
 * @param {Object} deps
 * @param {import("../../bootstrap.js").AppState} deps.state
 * @param {HTMLElement|null} deps.storageUsageTextEl
 * @param {HTMLElement|null} deps.storageAlertTextEl
 * @param {Function}    deps.fetchJson
 * @param {(bytes: number) => string} deps.formatBytes
 * @param {(text: string) => Promise<boolean>} deps.openConfirmModal
 * @param {(msg: string, opts?: object) => void} deps.showStatus
 * @param {() => Promise<void>} deps.onLoadUsers
 * @returns {{ renderUsage: Function, loadUsage: Function, runCleanup: Function, updateLimitForCurrentUser: Function }}
 */
